...
> https://www.nuget.org/packages?q=IczpNet

## [IczpNet.AbpTrees](https://www.nuget.org/packages?q=IczpNet.AbpTrees&includeComputedFrameworks=true&prerel=true&sortby=relevance)
...
```bash
dotnet nuget push "src/*/bin/Release/*0.2.4.nupkg" --skip-duplicate -k {APIKEY} --source https://api.nuget.org/v3/index.json
```
